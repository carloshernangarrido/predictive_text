...
class MyCustomCompleter(Completer):
    def __init__(self, ngram_size: int, model: Sequential, tokenizer: Tokenizer):
    ...
    def get_completions(self, document, complete_event):
        ...
        predicted_words = predict_next_words(self.model, self.tokenizer, text_list[:-1], self.ngram_size, n_preds=100)
